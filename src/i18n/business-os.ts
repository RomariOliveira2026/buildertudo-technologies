...
const en = {
  ...
  activity: {
    ...
    items: {
      ...
      '6': { title: 'Stripe payment received', detail: 'ContentFy Enterprise — status registrado', time: '2h ago' },
  ...
  copilot: {
    ...
    sections: {
      brief: { title: 'Revenue forecast', items: ['Revenue forecast demonstration — no real financial data is displayed.'] },
      health: { title: 'Framework Health', items: ['Demonstration health indicators available. Deploy pipeline shown for product demonstration.'] },
      deploy: { title: 'Deploy status', items: ['Last deploy: JurisMind v2.1.3 — success. monitoring available in the operational environment.'] },
      alerts: { title: 'Risk alerts', items: ['Staging environment — demonstration alert.', 'BuilderLeads webhook queue — 2 pending events.'] },
  ...
  infrastructure: {
    ...
    overviewTitle: 'Distributed architecture overview',
    overviewDescription: 'A structured operating model connecting regional nodes, core infrastructure and the application stack.',
    showcaseData: 'Static showcase data',
    indicatorsAria: 'Infrastructure showcase indicators',
    distributedNodes: 'Distributed nodes',
    architectureStack: 'Architecture stack',
    showcaseMetric: 'Showcase metric',
    status: 'Status',
    showcase: 'Showcase',
    architectureModel: 'Architecture model',
    architectureAria: 'Conceptual flow from regions through core infrastructure to services',
    regionalNode: 'Regional node',
    coreInfrastructure: 'Core infrastructure',
    coreDescription: 'Routing · orchestration · observability',
    edgeDelivery: 'Edge / Delivery',
    aiProviders: 'AI Providers',
    dataPlatform: 'Data / Platform',
    payments: 'Payments',
    applicationLayer: 'Application Layer',
    applicationLayerAria: 'Conceptual application layer',
    applicationItems: ['Business OS', 'SaaS Products', 'AI Workflows'],
  },
} as const
...
const es: BusinessOSCopy = {
  ...
  activity: {
    ...
    items: {
      ...
      '6': { title: 'Pago de Stripe recibido', detail: 'ContentFy Enterprise — estado registrado', time: 'hace 2 h' },
    },
  },
  copilot: {
    ...
    sections: {
      brief: { title: 'Pronóstico de ingresos', items: ['Demostración de previsión de ingresos — no se muestran datos financieros reales.'] },
      health: { title: 'Salud del Framework', items: ['Indicadores demostrativos de salud disponibles. Pipeline mostrado para demostración del producto.'] },
      deploy: { title: 'Estado del despliegue', items: ['Último despliegue: JurisMind v2.1.3 — exitoso. monitoreo disponible en el entorno operativo.'] },
      alerts: { title: 'Alertas de riesgo', items: ['Entorno de staging — alerta demostrativa.', 'Cola de webhooks de BuilderLeads — 2 eventos pendientes.'] },
  ...
  infrastructure: {
    ...
    overviewTitle: 'Visión de arquitectura distribuida',
    overviewDescription: 'Un modelo operativo estructurado que conecta nodos regionales, infraestructura central y la capa de aplicaciones.',
    showcaseData: 'Datos estáticos de showcase',
    indicatorsAria: 'Indicadores demostrativos de infraestructura',
    distributedNodes: 'Nodos distribuidos',
    architectureStack: 'Stack de arquitectura',
    showcaseMetric: 'Métrica de showcase',
    status: 'Estado',
    showcase: 'Showcase',
    architectureModel: 'Modelo de arquitectura',
    architectureAria: 'Flujo conceptual desde regiones hacia infraestructura central y servicios',
    regionalNode: 'Nodo regional',
    coreInfrastructure: 'Infraestructura central',
    coreDescription: 'Enrutamiento · orquestación · observabilidad',
    edgeDelivery: 'Edge / Entrega',
    aiProviders: 'Proveedores de IA',
    dataPlatform: 'Datos / Plataforma',
    payments: 'Pagos',
    applicationLayer: 'Capa de aplicaciones',
    applicationLayerAria: 'Capa conceptual de aplicaciones',
    applicationItems: ['Business OS', 'Productos SaaS', 'Flujos de IA'],
  },
}
...
const ptBR: BusinessOSCopy = {
  ...
  activity: {
    ...
    items: {
      ...
      '6': { title: 'Pagamento via Stripe recebido', detail: 'ContentFy Enterprise — status registrado', time: 'há 2 h' },
    },
  },
  copilot: {
    ...
    sections: {
      brief: { title: 'Previsão de receita', items: ['Demonstração de previsão de receita — nenhum dado financeiro real é exibido.'] },
      health: { title: 'Saúde do Framework', items: ['Indicadores demonstrativos de saúde disponíveis. Pipeline exibido para demonstração do produto.'] },
      deploy: { title: 'Status do deploy', items: ['Último deploy: JurisMind v2.1.3 — sucesso. monitoramento disponível no ambiente operacional.'] },
      alerts: { title: 'Alertas de risco', items: ['Ambiente de staging — alerta demonstrativo.', 'Fila de webhooks do BuilderLeads — 2 eventos pendentes.'] },
  ...
  infrastructure: {
    ...
    globalInfrastructure: 'Infraestrutura global',
    overviewTitle: 'Visão da arquitetura distribuída',
    overviewDescription: 'Um modelo operacional estruturado que conecta nós regionais, infraestrutura central e a camada de aplicações.',
    showcaseData: 'Dados estáticos de showcase',
    indicatorsAria: 'Indicadores demonstrativos de infraestrutura',
    distributedNodes: 'Nós distribuídos',
    architectureStack: 'Stack de arquitetura',
    showcaseMetric: 'Métrica de showcase',
    status: 'Status',
    showcase: 'Showcase',
    architectureModel: 'Modelo de arquitetura',
    architectureAria: 'Fluxo conceitual das regiões para a infraestrutura central e os serviços',
    regionalNode: 'Nó regional',
    coreInfrastructure: 'Infraestrutura central',
    coreDescription: 'Roteamento · orquestração · observabilidade',
    edgeDelivery: 'Edge / Entrega',
    aiProviders: 'Provedores de IA',
    dataPlatform: 'Dados / Plataforma',
    payments: 'Pagamentos',
    applicationLayer: 'Camada de aplicações',
    applicationLayerAria: 'Camada conceitual de aplicações',
    applicationItems: ['Business OS', 'Produtos SaaS', 'Workflows de IA'],
  },
}
